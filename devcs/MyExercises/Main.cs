...
namespace MyExercises
{
	class Program
	{
		public static void Main(string[] args)
		{
			...
			//nv_tutorial03_exercise01.MainProgram();
			//nv_tutorial06_exercise01.MainProgram();
			//nv_tutorial06_exercise02.MainProgram();
			MainClass.MainProgram();
			//Console.WriteLine(Matrix.Norm(new Matrix(new double [,]{ { 1 },{ 0 },{ 0 } })));
